...
public final class AppUtil { 
	...
	public static String buildSystemInfo(Context context) {
		...
		buffer.append(AppUtil.getVersionName(context));
		buffer.append("\n");
		buffer.append("version-code:");
		buffer.append(AppUtil.getVersionCode(context));
		buffer.append("\n");
		buffer.append("system-version:");
		buffer.append(AppUtil.getSystemVersion(context));
		buffer.append("\n");
		buffer.append("model:");
		buffer.append(AppUtil.getModel(context));
		buffer.append("\n");
		buffer.append("density:");
		buffer.append(AppUtil.getDensity(context));
		buffer.append("\n");
		buffer.append("imei:");
		buffer.append(AppUtil.getIMEI(context));
		buffer.append("\n");
		buffer.append("screen-height:");
		buffer.append(AppUtil.getScreenHeight(context));
		buffer.append("\n");
		buffer.append("screen-width:");
		buffer.append(AppUtil.getScreenWidth(context));
		buffer.append("\n");
		buffer.append("unique-code:");
		buffer.append(AppUtil.getUniqueCode(context));
		buffer.append("\n");
		buffer.append("mobile:");
		buffer.append(AppUtil.getMobile(context));
		buffer.append("\n");
		buffer.append("imsi:");
		buffer.append(AppUtil.getProvider(context));
		buffer.append("\n");
		buffer.append("isWifi:");
		buffer.append(AppUtil.isWifi(context));
		buffer.append("\n");
